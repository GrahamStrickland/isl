...
\begin{itemize}
    ...
    \verb|displacement|, \par \verb|horsepower|, \verb|weight|,
    \verb|acceleration|,
    \verb|year|, and \verb|origin|. The only qualitative predictor is
    \verb|name|.
  ...
  \item[(e)]
    In Figure~\ref{fig2_9scat}, we have plots of the \verb|Auto| data
    highlighting
    ...
    number of cylinders and the gas mileage (\verb|mpg|)of the
    vehicle in question.
