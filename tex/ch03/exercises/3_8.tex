...
1 24.46708 14.8094 34.12476
        ...
        value.
    \end{itemize}
  \item[(b)] In Figure~\ref{fig3_8reg}, we have a plot of the
    ...
    \end{figure}
  \item[(c)] In Figure~\ref{fig3_8diag}, we have a plot of the
    default diagnostics
    ...
    \end{figure}
    We can see from these plots that there are 3 high leverage points
    corresponding
    to observations 323, 330, and 334. From the residual plots, we can also see
    the data follows a very clear pattern, bringing into question the
    conclusions
    of 3.8(a). From this we may conclude that there are some problems
    with applying
