...
\begin{itemize}
  \item[(a)]
    Since $\hat{\beta}_1 = 20$, $\hat{\beta}_2 = 0.07$, and
    $\hat{\beta}_3 = 35$,
    we can conclude that IQ has little effect on starting salary by
    itself, while
    ...
    negative correlation between GPA and level, while $\hat{\beta}_4
    = 0.01$ shows
    ...
    interacting with level will bring down the response if GPA is not
    high enough.
  \item[(b)]
    For a college graduate with IQ of 110 and a GPA of 4.0, we have
    the following
    \begin{equation*}
      \begin{split}
